...
appfolderdir=/u01/eirsapp/ipLocationApi
datafolder=/u02/eirsdata/logs/ipLocationApi

mkdir -p ${appfolderdir}
mkdir -p ${datafolder}

echo `tar -xzvf '' >> ipLocationApi_Module_untar_$(date +%Y%m%d)_log.txt`
echo `mv ipLocationApi/* ${appfolderdir}`
...
two()
{
	./eirs_ip_location_api_module_db_installation.sh
pause
}
...
echo -e ""
echo -e "         #############################################################"
echo -e "         ##          EIRS IP Location API MODULE INSTALLATION       ##"
echo -e "         ##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~##"
